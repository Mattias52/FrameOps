...
const LandingPage: React.FC<LandingPageProps> = ({ onNavigate, onGetStarted }) => {
  const features = [
    ...
    },
    {
      ...
      description: 'Review and refine every step. Add safety notes, adjust descriptions, reorder procedures.'
    },
    {
      icon: 'fa-file-pdf',
  ...
  const useCases = [
    { industry: 'Manufacturing', example: 'Machine setup, maintenance procedures, quality checks' },
    { industry: 'Healthcare', example: 'Clinical procedures, equipment operation, sterilization' },
    { industry: 'Food Service', example: 'Health code compliance, recipes, cleaning procedures' },
    { industry: 'Training & HR', example: 'Onboarding, safety training, compliance documentation' },
  ];
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-slate-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-6 text-slate-500 text-sm">
            No credit card required. 3 SOPs free every month.
          </p>
        </div>
      </section>
